...
public class Solution {
	...
	public static void main(String[] args) {
		...
		/*There are six ways to fill in the missing elements. 
		 Out of those six permutations, only two have sortedness 5: {4, 1, 5, 2, 3} and {4, 3, 1, 2, 5}.*/ 
		...
		test = test(test,100,new int[]{0, 13, 0, 0, 12, 0, 0, 0, 2, 0, 0, 10, 5, 0, 0, 0, 0, 0, 0, 7, 15, 16, 20},53447326);  
	...
	private static List<List<Integer>> getPerms(List<Integer> items, int index) {
		...
		List<List<Integer>> subPerms = getPerms(items.subList(1, items.size()),0);
